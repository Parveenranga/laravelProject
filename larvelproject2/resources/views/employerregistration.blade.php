...
<html class="no-js" lang="zxx">
   ...
   @include('/layouts/header')
    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <form action="#" method="POST" enctype="multipart/form-data" id="employerForm">
                @csrf
     <input type="hidden" name="form_type" value="employer">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="doincorporation" class="form-control" required>
                </div>
                <div class="mb-3">
                    <label class="form-label">Address</label>
                    <textarea type="date" name="address" class="form-control" required></textarea>
                </div>
                <div class="mb-3">
